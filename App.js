...
const ResrtaurantCard = (props) => {
  const { resData } = props;
  const { cloudinaryImageId, name, locality, cuisines, avgRatingString } =
    resData?.info;
  return (
...
const resList = [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-05-18 12:00:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-05-18 23:45:00",
        opened: true,
      },
      badges: {
        textExtendedBadges: [
  ...
  },
  {
    info: {
      ...
      name: "KFC",
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2024/4/17/283329f9-5ad8-4c46-9177-6b23b6eb2966_17105.JPG",
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-05-25 00:00:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2024/4/17/f92c604d-68cb-49db-8dec-9473650c363d_734888.JPG",
  ...
  },
  {
    info: {
      ...
      cloudinaryImageId: "apsnjkb6pos68ei91ylm",
      locality: "GANDHAMGUDA",
      areaName: "Suncity",
      costForTwo: "₹200 for two",
    ...
    analytics: {},
    cta: {
      link: "https://www.swiggy.com/restaurants/the-thick-shake-factory-gandhamguda-suncity-hyderabad-579411",
      type: "WEBLINK",
    },
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-05-18 15:00:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      cloudinaryImageId: "rftglranm8fftfzzg0u5",
      ...
      availability: {
        nextCloseTime: "2024-05-19 03:50:00",
        opened: true,
      },
      badges: {
        imageBadges: [
    ...
    analytics: {},
    cta: {
      link: "https://www.swiggy.com/restaurants/kwality-walls-frozen-dessert-and-ice-cream-shop-sri-ram-nagar-colony-banjara-hills-hyderabad-593811",
      type: "WEBLINK",
    },
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-05-18 11:00:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-05-19 01:30:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
    ...
    <div className="body">
      ...
      <div className="res-container">
        {resList.map((restaurant) => (
          <ResrtaurantCard key={restaurant.info.id} resData={restaurant} />
        ))}
        ;
      </div>
    </div>
